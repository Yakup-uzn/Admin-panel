...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="#">
      ...
      <a class="navbar-brand" href="#">UZN MOBİLYA</a>
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Dolap</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Masa</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Ünite</a>
        </li>
      </ul>
      <form class="d-flex">
        <button id="girisButton" class="btn btn-light" data-id="' . $row['id'] . '" type="button">Giriş yap</button>
      </form>
    </div>
  </div>
</nav>
